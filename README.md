...
The SeabORD Individual Based Model is Crown copyright (i.e. it was created by civil servants in the course of their duties). The Scottish Government has provided UKCEH with permission to distribute this version of SeabORD under Open Government Licence (OGL). Please find a link to the Open Government Licence terms here: [Open Government Licence](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/). The attribution statement below is published alongside this version of SeabORD so that potential re-users will know that the information is subject to OGL terms:

‘Scottish Government. © Crown copyright, 2024. This version SeabORD is licensed under the Open Government Licence 3.0.’
